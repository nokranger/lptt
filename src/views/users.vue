            ...
            <b-form @submit="onSubmit" v-if="show">
              <div>
                <b-form-group id="input-group-1">
                  ...
                  <label
                    style="font-size:10px;display:block;text-align:left;color:gray;"
              ...
              <div>
                <b-form-group id="input-group-3">
                  ...
                  <label
                    style="font-size:10px;display:block;text-align:left;color:gray;"
                  >We’ll occasionally send updates about your account to this inbox. We’ll never share your email address with anyone.</label>
                </b-form-group>
              </div>
              ...
              <b-form-group id="input-group-2">
                ...
                <label
                  style="font-size:10px;display:block;text-align:left;color:gray;"
                >Make sure it's at least 15 characters OR at least 8 characters including a number and a lowercase letter. Learn more.</label>
              </b-form-group>
              <div>
